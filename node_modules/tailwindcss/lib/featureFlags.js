...
function issueFlagNotices(config) {
  ...
  if (futureFlagsEnabled(config).length > 0) {
    ...
    _log.default.info([`You have opted-in to future-facing breaking changes: ${changes}`, 'These changes are stable and will be the default behavior in the next major version of Tailwind.']);
  }
